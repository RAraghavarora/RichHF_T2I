...
convnext_dataset_train = load_dataset('appliedml2024/Vision_DiNOv2', split='dinov2_train')['features']
convnext_dataset_val = load_dataset('appliedml2024/Vision_DiNOv2', split='dinov2_dev')['features']
convnext_dataset_test = load_dataset('appliedml2024/Vision_DiNOv2', split='dinov2_test')['features']
...
torch.save(model.state_dict(), './mlpdinobert.pth')
