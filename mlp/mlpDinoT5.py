...
sfr_dataset_train = textembed_dataset_train['Sentence_T5_text_embedding']
sfr_dataset_val = textembed_dataset_val['Sentence_T5_text_embedding']
sfr_dataset_test = textembed_dataset_test['Sentence_T5_text_embedding']
...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(1792,1195) # TODO sweep hidden layer num
        self.lnorm1 = nn.LayerNorm(1195)
        self.relu1 = nn.ReLU()
        self.fc2 = nn.Linear(1195,797)
        self.lnorm2 = nn.LayerNorm(797)
        self.relu2 = nn.ReLU()
        self.fc3 = nn.Linear(797,531)
        self.lnorm3 = nn.LayerNorm(531)
        self.relu3 = nn.ReLU()
        self.fc4 = nn.Linear(531,354)
        self.lnorm4 = nn.LayerNorm(354)
        self.relu4 = nn.ReLU()
        self.fc5 = nn.Linear(354,236)
        self.lnorm5 = nn.LayerNorm(236)
        self.relu5 = nn.ReLU()
        self.fc6 = nn.Linear(236,164)
        self.lnorm6 = nn.LayerNorm(164)
        self.relu6 = nn.ReLU()
        self.fc7 = nn.Linear(164,1)
