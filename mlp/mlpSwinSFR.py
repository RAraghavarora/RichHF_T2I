...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.relu2 = nn.ReLU()
        self.fc3 = nn.Linear(2275,1517)
        self.lnorm3 = nn.LayerNorm(1517)
        self.relu3 = nn.ReLU()
        self.fc4 = nn.Linear(1517,1011)
        self.lnorm4 = nn.LayerNorm(1011)
        self.relu4 = nn.ReLU()
        self.fc5 = nn.Linear(1011,674)
        self.lnorm5 = nn.LayerNorm(674)
        self.relu5 = nn.ReLU()
        self.fc6 = nn.Linear(674,449)
